...
const WelcomePage = () => {
    return(
        ...
        <div className="grid grid-cols-1 gap-20 md:grid-cols-2 md:min-h-screen p-10 w-full h-full place-items-center">
            ...
            <div>
                <div>
                    <h1 className="text-3xl font-semibold md:text-5xl mb-1">Saqib Murtaza</h1>
                    <p className="mt-1 mb-2 font-semibold text-teal-400 text-lg md:text-3xl">A Bit About Me</p>
                </div>
