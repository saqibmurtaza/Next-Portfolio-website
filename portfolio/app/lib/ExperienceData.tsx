...
export const experienceData: resumeDataType[] = [
    
    {
        ...
        details : [
            "As the owner and manager of a family stationery business, I successfully \
            oversaw day-to-day operations, inventory management, and customer relations.",
            'Implemented cost-effective strategies that led to a 30 % increase in profit margins \
    ...
    {    
        ...
        details : [
            'Managed coordination between departments, fostering effective communication \
            and alignment of goals.', 
            'Assisted in project planning and execution, ensuring timely \
            completion and quality deliverables.'
        ]
    },
    {
        id : 3,
        ...
        details : [
            'Coordinated projects, gathered and analyzed data, and prepared \
            insightful reports to support decision-making.',
            'Contributed to process improvement by identifying bottlenecks and suggesting solutions.'
        ]
    },
    {
        id : 4,
        ...
        details : [
            'Lead administrative functions, overseeing facilities, procurement, and \
            resource management.',
            'Developed and implemented policies to enhance organizational efficiency \
    ...
    },  
    {
        ...
        details : [
            'Successfully managed branch operations, leading a team to achieve sales targets and \
            enhance customer satisfaction.',
            'Implemented strategic initiatives that resulted in increased profitability and \
            market share.'
        ]
    },
    ...
    export const additionalSkills: resumeDataType[] = [
        ...
        },
        {
            ...
            details: [
                    'Established and managed a successful reselling business on Instagram, \
                    Facebook, and TikTok, showcasing a variety of products.',
                    'Utilized marketing strategies to enhance online visibility and drive sales, \
                    resulting in increased revenue.',
                    'Created and maintained a furniture website, overseeing content creation \
        ...
        },
        {
            ...
            details: [
                ...
                increase website traffic, and enhance overall online presence.'
            ]
        }
