    ...
    <main className='bg-teal-50 font-medium min-h-screen text-teal-950'>
      ...
      <div className='pe-9 ps-9 pt-5'>
        <div>
          ...
          <p className='para'>
              With a rich background spanning 15 years across diverse sectors, I have amassed 
        ...
        <h1 className='block'>Academic Progress</h1>
          <p className='para'>
            As of the second quarter of my academic journey, I have covered foundational concepts 
        ...
        <div>
          ...
          <li className='font-bold '>Coding Proficiency:</li>
            <p className='para ps-5'>
              During my academic journey, I have developed a Coding Proficiency & fluent in languages such
              as Javascript & Typescript
            </p>
          <li className='font-bold '>Web development skills</li>
            <p className='para ps-5'>
              I have delved into Next.js, a powerful React framework. I have acquired a solid 
