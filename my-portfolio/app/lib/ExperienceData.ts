...
export const experienceData: resumeDataType[] = [
    ...
    export const additionalSkills: resumeDataType[] = [
        ...
        },
        {
            ...
            details: 'Established and managed a successful reselling business on Instagram, Facebook, and TikTok, showcasing a variety of products.Utilized marketing strategies to enhance online visibility and drive sales, resulting in increased revenue.Created and maintained a furniture website, overseeing content creation and product listings.'
        },
        {
            id : 8,
            company: "Digital Marketing and E-commerce Manager of Furniture Factory",
            duration: 'Jan 2020 to present',
            details: 'Managed social media accounts for the furniture business Js Furniture on Instagram, TikTok, and Facebook, consistently engaging with the audience and building brand awareness. Implemented effective digital marketing techniques to promote products, increase website traffic, and enhance overall online presence.'
        }
